...
xgettext *.php */*.php --copyright-holder='Vehicules Development Team' --package-name='GLPI - Vehicules plugin' --package-version='1.9.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
