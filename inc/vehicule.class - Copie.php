...
class PluginVehiculesVehicule extends CommonDBTM {
   ...
   function getSearchOptions() {
      ...
      $tab[3]['field']           = 'num_immat';
      $tab[3]['name']            = __('Numéro Immat (A)');
      
      $tab[4]['table']           = $this->getTable();
      $tab[4]['field']           = 'date_immat';
      $tab[4]['name']            = __('Date 1er Immat (B)', 'vehicules');
      $tab[4]['datatype']        = 'date';
          
      $tab[5]['table']           = 'glpi_plugin_vehicules_vehiculemarques';
      $tab[5]['field']           = 'name';
      $tab[5]['name']            = __('Marque (D1)');
      $tab[5]['datatype']        = 'dropdown';
      
      $tab[6]['table']           = 'glpi_plugin_vehicules_vehiculemodeles';
      $tab[6]['field']           = 'name';
      $tab[6]['name']            = __('Modele (D.2)');
      $tab[6]['datatype']        = 'dropdown';
      
      $tab[7]['table']           = $this->getTable();
      $tab[7]['field']           = 'denom_com';
      $tab[7]['name']            = __('Dénomination commerciale (D3)'); 
      
      $tab[8]['table']           = 'glpi_plugin_vehicules_vehiculegenres';
      $tab[8]['field']           = 'name';
      $tab[8]['name']            = __('Genre (J1)');
      $tab[8]['datatype']        = 'dropdown';
        
      $tab[9]['table']           = $this->getTable();
      $tab[9]['field']           = 'date_expiration';
      $tab[9]['name']            = __('Visite avant le (X1)', 'vehicules');
      $tab[9]['datatype']        = 'date';
      ...
      $tab[11]['field']           = 'date_affectation';
      $tab[11]['name']            = __('Affectation date', 'vehicules');
      $tab[11]['datatype']        = 'date';
      
      $tab[12]['table']           = 'glpi_states';
      ...
      $tab[15]['field']           = 'code_ident';
      $tab[15]['name']            = __('Code Identification (D2.1)');
   
      $tab[16]['table']           = $this->getTable();
      $tab[16]['field']           = 'num_ident';
      $tab[16]['name']            = __('Numéro identification (E)');   
      
      $tab[17]['table']           = 'glpi_plugin_vehicules_vehiculecarburants';
      $tab[17]['field']           = 'name';
      $tab[17]['name']            = __('Carburant (P3)');
      $tab[17]['datatype']        = 'dropdown';
      
      $tab[18]['table']           = $this->getTable();
      $tab[18]['field']           = 'puissance_admin';
      $tab[18]['name']            = __('Puissance Administrative (P6)');
      
      $tab[19]['table']           = $this->getTable();
      $tab[19]['field']           = 'comment';
      $tab[19]['name']            = __('Comments');
