...
class PluginVehiculesVehiculeCarburant extends CommonDropdown {
   
   static function getTypeName($nb=0) {
      return _n('Carburant (P3)', 'Carburant (P3)', $nb, 'vehicules');
   }
   ...
   static function transfer($ID, $entity) {
      ...
      if ($ID>0) {
         ...
         // Search init item
         $query = "SELECT *
                   FROM `glpi_plugin_vehicules_vehiculecarburants`
                   WHERE `id` = '$ID'";
