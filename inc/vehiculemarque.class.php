...
class PluginVehiculesVehiculeMarque extends CommonDropdown {
   
   static function getTypeName($nb=0) {
      return _n('Marques des Vehicules (D1)', 'Marques des Vehicules (D1)', $nb, 'vehicules');
   }
   ...
   static function transfer($ID, $entity) {
      ...
      if ($ID>0) {
         ...
         // Search init item
         $query = "SELECT *
                   FROM `glpi_plugin_vehicules_vehiculetypes`
                   WHERE `id` = '$ID'";
