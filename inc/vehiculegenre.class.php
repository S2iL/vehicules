...
class PluginVehiculesVehiculeGenre extends CommonDropdown {
   
   static function getTypeName($nb=0) {
      return _n('Genre Nationnal (J1)', 'Genre Nationnal des Vehicules (J1)', $nb, 'vehicules');
   }
   ...
   static function transfer($ID, $entity) {
      ...
      if ($ID>0) {
         ...
         // Search init item
         $query = "SELECT *
                   FROM `glpi_plugin_vehicules_vehiculegenres`
                   WHERE `id` = '$ID'";
