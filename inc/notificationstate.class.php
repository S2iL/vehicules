...
class PluginVehiculesNotificationState extends CommonDBTM {
   ...
   function showAddForm($target) {
      ...
      _e('Unused status for expiration mailing', 'vehicules');
      echo "</th></tr>";
   ...
   function showForm($target) {
      ...
      if ($result = $DB->query($query)) {
         ...
         if ($number != 0) {
            ...
            echo "<tr>";
            echo "<th></th><th>" . __('Unused status for expiration mailing', 'vehicules') . "</th>";
            echo "</tr>";
