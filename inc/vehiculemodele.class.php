...
class PluginVehiculesVehiculeModele extends CommonDropdown {
   
   static function getTypeName($nb=0) {
      return _n('Modèles des Vehicules (D2)', 'Modèles des Vehicules (D2)', $nb, 'vehicules');
   }
   ...
   static function transfer($ID, $entity) {
      ...
      if ($ID>0) {
         ...
         // Search init item
         $query = "SELECT *
                   FROM `glpi_plugin_vehicules_vehiculemodeles`
                   WHERE `id` = '$ID'";
